...
public class MenuItemDaoSqlImplTest {
	...
	public static void main(String[] args) {
		...
		menuItemDao = context.getBean(MenuItemDaoSqlImpl.class);
	...
	public static void testModifyMenuItem() {
		MenuItem menuItem = new MenuItem(2, "Hotdog", 129f, true,DateUtil.convertToDate("23/12/2017"), "Main Course", false);
